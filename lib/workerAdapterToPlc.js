...
module.exports = (adsC, adapter, emitter, state, id) => {
  ...
  adapter.getObject(id, (err, obj) => {
    ...
    if (obj.native.bytelength.name === 'STRING' && state.val > 80) {
      adapter.log.warn(`WorkerAdapterToPLC received a String that is longer as 80 Chars: ${symname} -> Cut to 80 Chars`);

declare module 'node-ads' {
     ...
     * +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     */
    interface AdsSymbolType {
        length: number;
        name: string;
    }

    interface AdsClientConnectOptions {
        /**
    ...
    interface AdsClientHandleAnswer extends AdsClientHandle {
        [propname: string]: any;
    }
    ...
    interface AdsReadDeviceInfoResult {
        majorVersion: number;
        minorVersion: number;
        versionBuild: number;
        deviceName: string;
    ...
    interface AdsClient extends EventEmitter {
        ...
        readDeviceInfo: (cb: (this: AdsClient, err: Error | null, result?: AdsReadDeviceInfoResult) => void) => void;
        read: (
            handle: AdsClientHandle,
            cb: (this: AdsClient, err: Error | null, handle: AdsClientHandleAnswer) => void,
        ) => void;
        write: (handle: AdsClientHandle, cb: (this: AdsClient, err: Error | null) => void) => void;
        readState: (cb: (this: AdsClient, err: Error | null, result?: AdsReadStateResult) => void) => void;
        notify: (handle: AdsClientHandle, cb?: (this: AdsClient, err: Error | null) => void) => void;
    ...
    const BOOL: AdsSymbolType;
    const BYTE: AdsSymbolType;
    const WORD: AdsSymbolType;
    const DWORD: AdsSymbolType;
    const SINT: AdsSymbolType;
    const USINT: AdsSymbolType;
    const INT: AdsSymbolType;
    const UINT: AdsSymbolType;
    const DINT: AdsSymbolType;
    const UDINT: AdsSymbolType;
    const LINT: AdsSymbolType;
    const ULINT: AdsSymbolType;
    const REAL: AdsSymbolType;
    const LREAL: AdsSymbolType;
    const TIME: AdsSymbolType;
    const TIME_OF_DAY: AdsSymbolType;
    const TOD: AdsSymbolType;
    const DATE: AdsSymbolType;
    const DATE_AND_TIME: AdsSymbolType;
    const DT: AdsSymbolType;
    const STRING: AdsSymbolType;
     ...
     * +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     */
    function connect(options: AdsClientConnectOptions, cb: (this: AdsClient) => void): AdsClient;
    function string(length?: number): AdsSymbolType;
    function array(typ: AdsSymbolType, lowIndex: number, hiIndex: number): AdsSymbolType;
    function useLocalTimezone(type: AdsSymbolType, use?: boolean): AdsSymbolType;
}
